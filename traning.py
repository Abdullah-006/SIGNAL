...
x_train, x_test, y_train, y_test = train_test_split(data, labels_encoded, test_size=0.3, shuffle=True, stratify=labels_encoded)
...
# Train the model
history = model.fit(flatten_train, y_train, epochs=10, batch_size=32)
